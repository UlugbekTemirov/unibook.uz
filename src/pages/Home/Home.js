    ...
    <>
      <div className="about-unibook-section">
        <div className="container">
          <h1>About <a href="#">Unibook.uz</a></h1>
          <div className="row">
            <div className="col-lg-6">
              <img src="https://picsum.photos/500/300?random=1" alt="random picture" />
            </div>
            <div className="col-lg-6">
            ...
            <div className="col col-xs-6">
              <div className="card">
                ...
                <div className="card-body">
                  <img src="https://picsum.photos/500/300?random=2" alt="team-member" />
                </div>
              </div>
            </div>
